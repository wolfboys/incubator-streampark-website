...
我们努力提供最好的用户体验是非常必要的。   
因此，我们引入了 [AbstractApiException](https://github.com/apache/streampark/blob/dev/streampark-console/streampark-console-service/src/main/java/org/apache/streampark/console/base/exception/AbstractApiException.java)
...
如果需要，请点击 [Issue-2325](https://github.com/apache/streampark/issues/2325) 以获取更多关于该项的详细信息。
