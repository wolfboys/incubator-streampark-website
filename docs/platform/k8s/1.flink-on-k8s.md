...
At now, one StreamPark only supports one Kubernetes cluster.You can submit [Fearure Request Issue](https://github.com/apache/streampark/issues) , when multiple Kubernetes clusters are needed.
<br></br>
