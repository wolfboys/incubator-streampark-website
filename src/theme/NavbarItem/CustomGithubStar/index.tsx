...
import type { IGithubInfo } from './types'

export default function CustomGithubStar(): JSX.Element {

    const { github: { stars } } = usePluginData("github-info-plugin") as IGithubInfo
